...
other than the discrete ordinates used in arriving at the solutions, and those
discrete ordinates themselves may be chosen in a strategic way for the problem
...
from the LDO equations. Fundamental studies of the LDO formulation were
conducted in their development, but the equations have never before
...
solver and the traditional discrete ordinates (\sn) approximation.

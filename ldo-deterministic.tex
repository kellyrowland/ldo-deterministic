...
Lastly, Table \ref{dlvn-stats} lists the reported run times and memory usage
for each quadrature set used in the various simulations of the DLVN benchmark.
We again see a drastic increase in run time when using an LDO quadrature set
as well as an increased memory requirement.

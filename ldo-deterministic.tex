...
\noindent In Eqs. \eqref{eq:sph_e} and \eqref{eq:sph_o},
...
\noindent Equation \eqref{ldo_op} is in the same form as Equation \eqref{l_inv},
...
\noindent In Equation \eqref{eq:ldosig}, $\Sigg{\ell}$ are the same cross section 
...
\noindent Again, we define $a$ and $b$ as calculated in Equation \eqref{eq:dims}.
...
\noindent Thus, based on Equation \eqref{eq:scalar_flux}, Denovo only retrieves

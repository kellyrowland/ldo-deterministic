...
\title{Assessment of the Lagrange Discrete Ordinates Equations for Three-Dimensional Neutron Transport} %title of paper
...
\begin{itemize}
\item{Compared LDO equations with standard quadrature sets}

...
\sum_{g'=0}^{G}\sum_{\ell=0}^{L}\Sigma_{s,\ell}^{g'\sa g}(\vecr)
...
\noindent where a standard multigroup energy approximation is used and the
angles are integrated by a quadrature rule such that
